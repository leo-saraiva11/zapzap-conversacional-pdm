  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(4) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        ...
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'fec49ccf15784bd823d926b58cd78f08')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        _columnsMessages.put("repliedMessageId", new TableInfo.Column("repliedMessageId", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsMessages.put("repliedMessageText", new TableInfo.Column("repliedMessageText", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsMessages.put("repliedMessageSender", new TableInfo.Column("repliedMessageSender", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
    ...
    }, "fec49ccf15784bd823d926b58cd78f08", "86caa3d35b756b4803bb51f829063248");
